...
{
    // FIXME: can optimize this by taking advantage of that they're sorted
...
std::ostream& operator<<(std::ostream& out, SchemaChange const& value)
{
    value.visit(SchemaChangePrinter{out});
    return out;
}
}
